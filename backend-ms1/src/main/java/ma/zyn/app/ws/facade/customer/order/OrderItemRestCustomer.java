...
public class OrderItemRestCustomer {
   ...
   public OrderItemRestCustomer(OrderItemCustomerService service, OrderItemConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final OrderItemCustomerService service;

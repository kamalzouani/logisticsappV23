package ma.zyn.app.service.impl.customer.customer;
...
import java.util.List;
@Service
public class CustomerCustomerServiceImpl implements CustomerCustomerService {
    ...
    public CustomerCustomerServiceImpl(CustomerDao dao) {
        this.dao = dao;
    }

package ma.zyn.app.service.impl.admin.delivery;
...
import java.util.List;
@Service
public class DeliveryStatusAdminServiceImpl implements DeliveryStatusAdminService {
    ...
    public DeliveryStatusAdminServiceImpl(DeliveryStatusDao dao) {
        this.dao = dao;
    }

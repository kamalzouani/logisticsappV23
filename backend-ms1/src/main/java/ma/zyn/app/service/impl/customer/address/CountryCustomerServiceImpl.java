...
import ma.zyn.app.service.facade.customer.address.CountryCustomerService;
...
import java.util.List;
@Service
public class CountryCustomerServiceImpl implements CountryCustomerService {
    ...
    public CountryCustomerServiceImpl(CountryDao dao) {
        this.dao = dao;
    }

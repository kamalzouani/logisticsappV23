...
import ma.zyn.app.service.facade.customer.address.CityCustomerService;
...
import java.util.List;
@Service
public class CityCustomerServiceImpl implements CityCustomerService {
    ...
    public CityCustomerServiceImpl(CityDao dao) {
        this.dao = dao;
    }

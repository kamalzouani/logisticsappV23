...
import ma.zyn.app.service.facade.customer.product.ProductCustomerService;
...
public class ProductCustomerServiceImpl implements ProductCustomerService {
    ...
    public long countByProductCategoryId(Long id){
        return dao.countByProductCategoryId(id);
    }
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
    ...
    public void findOrSaveAssociatedObject(Product t){
        if( t != null) {
        }
    }
    ...
    @Autowired
    private ProductCategoryCustomerService productCategoryService ;

    public ProductCustomerServiceImpl(ProductDao dao) {
        this.dao = dao;
    }

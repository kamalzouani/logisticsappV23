function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/logisticsappv23';
    ...
    config.addressUrl = config.adminUri + 'address/';
    config.cityUrl = config.adminUri + 'city/';
    config.deliveryUrl = config.adminUri + 'delivery/';
    config.deliveryStatusUrl = config.adminUri + 'deliveryStatus/';
    config.orderUrl = config.adminUri + 'order/';
    config.orderStatusUrl = config.adminUri + 'orderStatus/';
    config.productUrl = config.adminUri + 'product/';
    config.productCategoryUrl = config.adminUri + 'productCategory/';
    config.orderItemUrl = config.adminUri + 'orderItem/';
    config.customerUrl = config.adminUri + 'customer/';

...
public class CustomerRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private CustomerAdminServiceImpl service;
    @Mock
    private CustomerConverter converter;

    @InjectMocks
    private CustomerRestAdmin controller;

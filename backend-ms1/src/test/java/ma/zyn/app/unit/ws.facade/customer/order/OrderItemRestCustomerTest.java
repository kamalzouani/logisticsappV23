...
import ma.zyn.app.service.impl.customer.order.OrderItemCustomerServiceImpl;
import ma.zyn.app.ws.facade.customer.order.OrderItemRestCustomer;
...
public class OrderItemRestCustomerTest {

    private MockMvc mockMvc;

    @Mock
    private OrderItemCustomerServiceImpl service;
    @Mock
    private OrderItemConverter converter;

    @InjectMocks
    private OrderItemRestCustomer controller;

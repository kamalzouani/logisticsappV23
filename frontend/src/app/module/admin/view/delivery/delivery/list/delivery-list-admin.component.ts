...
export class DeliveryListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DeliveryDto>();
    ...
    public async edit(dto: DeliveryDto) {
    ...
    public async view(dto: DeliveryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DeliveryDto) {
    ...
    public async duplicate(dto: DeliveryDto) {
    ...
    public exportPdf(dto: DeliveryDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'deliveryStatus?.label', header: 'Delivery status'},
            {field: 'order?.id', header: 'Order'},
        ];
    }
    ...
    public async loadDeliveryStatus(){
        this.deliveryStatusService.findAllOptimized().subscribe(deliveryStatuss => this.deliveryStatuss = deliveryStatuss, error => console.log(error))
    }
    public async loadOrder(){
        this.orderService.findAll().subscribe(orders => this.orders = orders, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Delivery status': e.deliveryStatus?.label ,
                'Order': e.order?.id ,
            }
        });
        ...
        //'Delivery status': this.criteria.deliveryStatus?.label ? this.criteria.deliveryStatus?.label : environment.emptyForExport ,
        //'Order': this.criteria.order?.id ? this.criteria.order?.id : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<DeliveryDto> {
        return this.service.selections;
    }

    set selections(value: Array<DeliveryDto>) {

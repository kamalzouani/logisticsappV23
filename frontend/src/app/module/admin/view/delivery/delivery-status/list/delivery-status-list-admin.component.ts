...
export class DeliveryStatusListAdminComponent implements OnInit {

    protected fileName = 'DeliveryStatus';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DeliveryStatusDto>();
    ...
    public async edit(dto: DeliveryStatusDto) {
    ...
    public async view(dto: DeliveryStatusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DeliveryStatusDto) {
    ...
    public async duplicate(dto: DeliveryStatusDto) {
    ...
    public exportPdf(dto: DeliveryStatusDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<DeliveryStatusDto> {
        return this.service.selections;
    }

    set selections(value: Array<DeliveryStatusDto>) {

...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'productCategory?.id', header: 'Product category'},
        ];
    }


    public async loadProductCategory(){
        this.productCategoryService.findAll().subscribe(productCategorys => this.productCategorys = productCategorys, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 ...
                 'Price': e.price ,
                 'Stock': e.stock ,
                'Product category': e.productCategory?.id ,
            }
        });
        ...
        //'Product category': this.criteria.productCategory?.id ? this.criteria.productCategory?.id : environment.emptyForExport ,
        }];
      }

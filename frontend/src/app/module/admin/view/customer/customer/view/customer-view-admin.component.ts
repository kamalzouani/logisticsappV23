...
@Component({
  selector: 'app-customer-view-admin',
  templateUrl: './customer-view-admin.component.html'
})
export class CustomerViewAdminComponent implements OnInit {
    ...
    constructor(private service: CustomerAdminService, private addressService: AddressAdminService){

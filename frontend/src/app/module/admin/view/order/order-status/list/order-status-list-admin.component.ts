...
export class OrderStatusListAdminComponent implements OnInit {

    protected fileName = 'OrderStatus';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<OrderStatusDto>();
    ...
    public async edit(dto: OrderStatusDto) {
    ...
    public async view(dto: OrderStatusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: OrderStatusDto) {
    ...
    public async duplicate(dto: OrderStatusDto) {
    ...
    public exportPdf(dto: OrderStatusDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<OrderStatusDto> {
        return this.service.selections;
    }

    set selections(value: Array<OrderStatusDto>) {

...
@Component({
  selector: 'app-order-item-view-admin',
  templateUrl: './order-item-view-admin.component.html'
})
export class OrderItemViewAdminComponent implements OnInit {
    ...
    constructor(private service: OrderItemAdminService, private orderService: OrderAdminService, private productService: ProductAdminService){

...
export class OrderListAdminComponent implements OnInit {
    ...
    constructor( private service: OrderAdminService  , private customerService: CustomerAdminService, private orderItemService: OrderItemAdminService, private productService: ProductAdminService, private orderStatusService: OrderStatusAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<OrderDto>();
    ...
    public async edit(dto: OrderDto) {
    ...
    public async view(dto: OrderDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: OrderDto) {
    ...
    public async duplicate(dto: OrderDto) {
    ...
    public exportPdf(dto: OrderDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'orderStatus?.label', header: 'Order status'},
            {field: 'customer?.email', header: 'Customer'},
        ];
    }


    public async loadOrderStatus(){
        this.orderStatusService.findAllOptimized().subscribe(orderStatuss => this.orderStatuss = orderStatuss, error => console.log(error))
    }
    public async loadCustomer(){
        this.customerService.findAllOptimized().subscribe(customers => this.customers = customers, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Order status': e.orderStatus?.label ,
        ...
        //'Order status': this.criteria.orderStatus?.label ? this.criteria.orderStatus?.label : environment.emptyForExport ,
        //'Customer': this.criteria.customer?.email ? this.criteria.customer?.email : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<OrderDto> {
        return this.service.selections;
    }

    set selections(value: Array<OrderDto>) {

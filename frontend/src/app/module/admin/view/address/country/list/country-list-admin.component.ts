...
@Component({
  selector: 'app-country-list-admin',
  templateUrl: './country-list-admin.component.html'
})
export class CountryListAdminComponent implements OnInit {

    protected fileName = 'Country';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CountryDto>();
    ...
    public async edit(dto: CountryDto) {
    ...
    public async view(dto: CountryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CountryDto) {
    ...
    public async duplicate(dto: CountryDto) {
    ...
    public exportPdf(dto: CountryDto): void {
...
// add
	...
	public initDuplicate(res: CountryDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CountryDto> {
        return this.service.selections;
    }

    set selections(value: Array<CountryDto>) {

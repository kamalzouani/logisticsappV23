...
@Component({
  selector: 'app-activation-customer',
  templateUrl: './activation-customer.component.html',
  styleUrls: ['./activation-customer.component.css']
})
export class ActivationCustomerComponent implements OnInit {

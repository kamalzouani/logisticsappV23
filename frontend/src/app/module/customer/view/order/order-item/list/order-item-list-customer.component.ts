...
@Component({
  selector: 'app-order-item-list-customer',
  templateUrl: './order-item-list-customer.component.html'
})
export class OrderItemListCustomerComponent implements OnInit {

    protected fileName = 'OrderItem';
    ...
    constructor( private service: OrderItemCustomerService  , private orderService: OrderCustomerService, private productService: ProductCustomerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<OrderItemDto>();
    ...
    public async edit(dto: OrderItemDto) {
    ...
    public async view(dto: OrderItemDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: OrderItemDto) {
    ...
    public async duplicate(dto: OrderItemDto) {
    ...
    public exportPdf(dto: OrderItemDto): void {
...
// add
    ...
    public async loadProduct(){
        this.productService.findAll().subscribe(products => this.products = products, error => console.log(error))
    }
	...
	public initDuplicate(res: OrderItemDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<OrderItemDto> {
        return this.service.selections;
    }

    set selections(value: Array<OrderItemDto>) {

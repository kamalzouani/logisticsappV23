...
@Component({
  selector: 'app-customer-view-customer',
  templateUrl: './customer-view-customer.component.html'
})
export class CustomerViewCustomerComponent implements OnInit {
    ...
    constructor(private service: CustomerCustomerService, private addressService: AddressCustomerService){

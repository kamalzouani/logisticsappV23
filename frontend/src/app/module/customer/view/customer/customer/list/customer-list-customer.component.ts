...
import {AddressCustomerService} from 'src/app/shared/service/customer/address/AddressCustomer.service';


@Component({
  selector: 'app-customer-list-customer',
  templateUrl: './customer-list-customer.component.html'
})
export class CustomerListCustomerComponent implements OnInit {
    ...
    constructor( private service: CustomerCustomerService  , private addressService: AddressCustomerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CustomerDto>();
    ...
    public async edit(dto: CustomerDto) {
    ...
    public async view(dto: CustomerDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CustomerDto) {
    ...
    public async duplicate(dto: CustomerDto) {
    ...
    public exportPdf(dto: CustomerDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'address?.id', header: 'Address'},
    ...
    public async loadAddress(){
        this.addressService.findAll().subscribe(addresss => this.addresss = addresss, error => console.log(error))
    }


	public initDuplicate(res: CustomerDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Address': this.criteria.address?.id ? this.criteria.address?.id : environment.emptyForExport ,
    ...
    get items(): Array<CustomerDto> {
        return this.service.items;
    }

    set items(value: Array<CustomerDto>) {
        this.service.items = value;
    }

    get selections(): Array<CustomerDto> {
        return this.service.selections;
    }

    set selections(value: Array<CustomerDto>) {
        this.service.selections = value;
    }

    get item(): CustomerDto {
        return this.service.item;
    }

    set item(value: CustomerDto) {
    ...
    get criteria(): CustomerCriteria {
        return this.service.criteria;
    }

    set criteria(value: CustomerCriteria) {

...
@Component({
    selector: 'app-forget-password-customer',
    templateUrl: './forget-password-customer.component.html',
    styleUrls: ['./forget-password-customer.component.css'],
})
export class ForgetPasswordCustomerComponent {
